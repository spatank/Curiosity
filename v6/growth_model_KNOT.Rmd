...
```{r}
processed_net_data <- read.csv("/Volumes/My Passport/Curiosity/v6/Data/KNOT/KNOT_data.csv", header = TRUE)
curiosity_5D <- read.csv("/Volumes/My Passport/Curiosity/v6/Data/KNOT/KNOT_5D.csv", header = TRUE)
all_data <- merge(processed_net_data, curiosity_5D, by = "ID", all = TRUE)
```
